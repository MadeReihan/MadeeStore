...
export default function index() {
    ...
    const onSubmit =async()=>{
        ...
        if(!email || !password){
            toast.error('isi email dan password dahulu')
        }else{
        ...
        <>
            ...
            <div className="pt-30">
                ...
                <input type="password" className="form-control rounded-pill text-lg" id="password"
                    name="password" aria-describedby="password" placeholder="Your password"value={password} onChange={(event) => setPassword(event.target.value)}/>
            </div>
